...
interface ModalVisualizarDependenteProps {
    show: boolean;
    handleClose: () => void;
}

const ModalVisualizarDependente: React.FC<ModalVisualizarDependenteProps> = ({ show, handleClose }) => {
    return (
            ...
            <Modal.Body>
                <Form>
                    ...
                    <Form.Group controlId="formDocumentos">
                        ...
                        <p><strong>Número:</strong> 2883828293</p>
                        <p><strong>Data de emissão:</strong>03/09/2017</p>
                        <br></br>
                        <p><strong>Tipo:</strong> RG</p>
                        <p><strong>Número:</strong> 647385637</p>
                        <p><strong>Data de emissão:</strong>03/09/2017</p>
                    </Form.Group>
...
export default ModalVisualizarDependente;
